...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($numExistRows > 0){
        ...
        if(($password == $cpassword)){
            ...
            $sql = "INSERT INTO `users` (`username`, `password`, `email`, `phno`) VALUES ('$username', '$hash', '$email', '$phno')";
...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg  navbar-dark bg-dark ">
    ...
    <div class="container my-4">
     ...
     <form action="/AH/signup.php" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="email" maxlength="25" class="form-control" id="email" name="email" required>
        </div>
        <div class="form-group">
            <label for="phno">Phone no.</label>
            <input type="tel" maxlength="10" class="form-control" id="phno" name="phno">
        </div>
